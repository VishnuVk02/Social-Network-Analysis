    ...
    <div className="p-8 w-full px-12 text-slate-350 space-y-10">
      ...
      <div className="flex items-center space-x-5">
        ...
        <div className="space-y-1">
          <h1 className="text-3xl font-black text-black tracking-tight flex items-center">
            GitHub Trends & Intelligence Dashboard
          </h1>
          <p className="text-slate-400 text-extra text-black ">Explore real-time telemetry updates, news, and technology analytics on GitHub.</p>
        </div>
      </div>
        ...
        {sidebarItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`px-5 py-3 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer flex items-center space-x-2 shrink-0 ${activeTab === item.id
                ? 'border-pine-500 text-pine-700 font-extrabold'
                : 'border-transparent text-slate-600 hover:text-black font-bold'
                }`}
            >
              <Icon className={`w-4 h-4 ${activeTab === item.id ? 'text-pine-600' : 'text-slate-500'}`} />
              ...
              <div className="glass-panel p-8 rounded-3xl space-y-6 shadow-glass-md">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-xs text-brand-450 hover:text-black font-bold transition-all cursor-pointer flex items-center"
                  >
              ...
              <div className="flex bg-slate-950 border border-slate-850 rounded-xl p-1 space-x-1">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${sortBy === filter.id
                ...
                <div key={r.id} className="glass-panel p-8 rounded-3xl flex flex-col justify-between space-y-6 hover:border-brand-500/25 transition-all shadow-glass-md">
                  ...
                  <div className="flex justify-between items-center text-xs font-bold pt-2">
                    <a
                      ...
                      className="flex items-center space-x-1.5 text-slate-400 hover:text-black transition-colors"
                    >
                ...
                <div key={item.id} className="glass-panel p-8 rounded-3xl relative overflow-hidden flex flex-col space-y-4 shadow-glass-md">
                  ...
                  <div className="flex flex-wrap justify-between items-start gap-3">
                    <div className="space-y-1.5">
                      <div className="flex items-center space-x-2">
                        <span className={`px-2.5 py-0.75 rounded text-[9px] uppercase font-black tracking-wider border ${item.type === 'RELEASE'
                  ...
                  {item.url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs font-bold text-brand-450 hover:text-black flex items-center w-fit pt-2"
                    >
                  ...
                  {dev.popularRepoName && (
                    <div className="p-4 bg-slate-950/60 border border-slate-850 rounded-2xl space-y-1.5 text-xs shrink-0 w-full md:w-64 text-center md:text-left shadow">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-bold text-brand-400 hover:text-black transition-colors truncate block font-mono text-sm"
                      >
                        {dev.popularRepoName}
                      </a>
                      <span className="text-xs text-coral-400 font-semibold font-mono flex items-center mt-1">
                        <Star className="w-3.5 h-3.5 mr-1 shrink-0 fill-coral-400/20" />
